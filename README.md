...
Позже, в docker-compose я добавил ограничения ресурсов системы;
В ssh сделал вход по ключам, а не паролям;
Также развернул на машине fail2ban.
